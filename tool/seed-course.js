    ...
    lessons: [
      {
        ...
        durationMinutes: 9,
        order: 0,
        transcript: 'Motion describes how an object changes position over time. Every observation of motion depends on a chosen frame of reference.',
      },
      {
        id: 'lesson-02',
        ...
        durationMinutes: 12,
        order: 1,
        transcript: 'Speed measures how fast an object moves, while velocity also specifies the direction of that movement.',
      },
      {
        id: 'lesson-03',
        ...
        durationMinutes: 14,
        order: 2,
        transcript: "Newton's First Law states that an object at rest stays at rest unless acted upon by an unbalanced force — the property known as inertia.",
      },
    ],
  },
  {
    ...
    lessons: [
      {
        ...
        durationMinutes: 10,
        order: 0,
        transcript: 'A variable is a symbol that represents an unknown quantity, and combining variables with numbers gives us algebraic expressions.',
      },
      {
        id: 'lesson-02',
        ...
        durationMinutes: 13,
        order: 1,
        transcript: 'Solving a linear equation means finding the value of the variable that makes both sides equal, verified by substituting the answer back in.',
      },
      {
        id: 'lesson-03',
        ...
        durationMinutes: 11,
        order: 2,
        transcript: 'Every linear equation can be graphed as a straight line whose steepness is its slope and whose crossing point on the y-axis is the y-intercept.',
      },
    ],
  },
];
